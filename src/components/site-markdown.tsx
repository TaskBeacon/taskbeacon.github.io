...
export function SiteMarkdown({
  ...
  const rawBase = "https://raw.githubusercontent.com/TaskBeacon/taskbeacon.github.io/main/source/";
  const blobBase = "https://github.com/TaskBeacon/taskbeacon.github.io/blob/main/source/";
    ...
    <ReactMarkdown
      ...
      components={{
        a: ({ href, children, ...props }) => {
          ...
          const isInternalSiteLink = h.startsWith("/");
          let nextHref = h;
          if (!isHash && !isInternalSiteLink && h && !isAbsoluteUrl(h)) {
            nextHref = joinPath(blobBase, h);
          }
          const external = !isHash && !isInternalSiteLink;
          return (
            <a
              href={nextHref}
